    ...
    Tool(
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "scope": {
                    "type": "string",
                    "enum": ["project", "all", "global"],
                    "default": "project",
                    "description": "project = current project + global (default); all = every project",
                },
            },
            "required": ["query"],
        },
        ...
        inputSchema={
            ...
            "properties": {
                ...
                "scope": {
                    ...
                    "enum": ["project", "global"],
                    "default": "project",
                    "description": "global = visible in every project (user-level rule)",
                },
            },
            "required": ["content"],
        },
